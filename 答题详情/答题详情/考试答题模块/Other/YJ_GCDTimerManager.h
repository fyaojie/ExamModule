...
typedef enum : NSUInteger {
    YJ_ActionOptionAbandonPrevious, // 废除同一个timer之前的任务
    YJ_ActionOptionMergePrevious    // 将同一个timer之前的任务合并到新的任务中
} YJ_ActionOption;

@interface YJ_GCDTimerManager : NSObject
...
- (void)scheduledDispatchTimerWithName:(NSString *)timerName
                          ...
                          actionOption:(YJ_ActionOption)option
